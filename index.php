...
<div class="containers">
    ...
    <div class="main">
                                        ...
                                        <div class="col-md-10 col-md-offset-1">
                                            ...
                                            <div class="content-slide">
                                                ...
                                                <h3 class="color-white top-margin animated bounceInDown"
                                                    data-animation-delay="700">Virtualization is the trend of the future.</h3>
                                                <p>Subscribe to get the best Virtualization content hand-delivered to your inbox for free.</p>
                                                ...
                                                <div class="form animated bounceInUp" data-animation-delay="700">
                                                    ...
                                                    <div class="container-form">
                                                        ...
                                                        <div class="section-page" id="signup">
                                                            <form class="subscription-form mailchimp" method="post"
                                                                  id="mc-form" action="get_email_page.php">
                                                                <input type="email" id="email"
                                                                       class="border-radius-22 bottom-margin"
                                                                       name="email"
                                                                       placeholder="Enter Your Email Address" required/>
                                                                <button type="submit" id="subscribebtn"
                                                                        class="border-button no-bottom-margin">Subscribe
                                                                </button>
                                                            </form>
        ...
        <hr style="width: 80%; border-top: 1px solid rgba(255, 255, 255, 0.32);">
                        ...
                        <div class="col-xs-12 col-md-6 animated bounceInLeft" data-animation-delay="700">
                            ...
                            <div class="pregress-bar">
                                <div class="skill-lockup">
                                    <span class="category-name mb">Servers Virtualization</span><span
                                            class="progress-status">90%</span>
                                ...
                                <div class="skill-lockup">
                                    <span class="category-name mb">Software virtualization</span><span
                                            class="progress-status">80%</span>
                                    <span class="skill-bar">
<span class="skill-level programming"></span>
                                ...
                                <div class="skill-lockup">
                                    <span class="category-name">Complex virtualization!</span><span
                                            class="progress-status">70%</span>
                                    <span class="skill-bar">
<span class="skill-level developing"></span>
                                ...
                                <div class="skill-lockup">
                                    <span class="category-name">API: Virtuaization directly from code!</span><span
                                            class="progress-status">85%</span>
                                    <span class="skill-bar">
<span class="skill-level supporting"></span>
</span>
                                </div><!-- /supporting -->
                                <div class="skill-lockup">
                                    <span class="category-name mb">Over Provisioning</span><span
                                            class="progress-status">0%</span>
                                    <span class="skill-bar">
                                      <span class="skill-level  provisioning"></span>
                                    </span>
                                </div><!-- /planning -->

                                <div class="skill-lockup">
                                    <span class="category-name mb">Live Burst</span><span
                                            class="progress-status">90%</span>
                                    <span class="skill-bar">
                                      <span class="skill-level  planning"></span>
                                    </span>
                                ...
                                <div class="skill-lockup">
                                    <span class="category-name mb">Live Scaling</span><span
                                            class="progress-status">90%</span>
                                    <span class="skill-bar">
                                      <span class="skill-level  planning"></span>
                                    </span>
                        ...
                        <div class="col-xs-12 col-md-6 video-section animated bounceInRight" data-animation-delay="700">
                            <div class="big-video center">
                                <img width="500" height="500" src="../images/printscreen-pepper-soft.jpg"/>
                            </div>
                        </div><!-- /video section -->
                    </div><!-- /row -->
                ...
                <div class="content-slide aboutus">
                    <div class="row">
                        <div class="col-xs-12 col-md-6 animated bounceInLeft" data-animation-delay="700">
                            ...
                            <p style="text-align: center;">We will answer your questions as soon as we can.</p>
                            ...
                            <form method="post" action="contact-form.php" class="contact-form">
                                ...
                                <button class="border-button" type="submit" id="submit" name="submit">Send Message
                                </button>
                        ...
                        <div class="col-xs-12 col-md-6 maps-section animated bounceInRight" data-animation-delay="700">
                            <div class="big-maps center">
                                <ul>
                                    <li><span>address: </span> Soseaua Pipera 41, Bucuresti, RO</li>
                                    <li><span>call us: </span><a href="tel:0737526006">(073) 752 6006</a></li>
                                    <li><span>email: </span><a href="mailto:office@pepper-soft.com">office@pepper-soft.com</a></li>
                                </ul>
                                <div id="map1"></div>
                            </div>
                        </div><!-- /maps section -->
        ...
        <footer class="copy-right animated bounceInUp" data-animation-delay="700">
            <div class="copyright">
                © 2016 <a href="https://pepper-soft.com">Pepper Soft Inc.</a> - All Rights Reserved
            </div>
        </footer><!-- /copyright -->
...
<script>
    <?php if ($mesaj = message()): ?>
    swal("Felicitari", "<?php echo $mesaj; ?>", "success");
    <?php endif; ?>
</script>
</body>
</html>
